...
export default function SignInScreen() {
  ...
  return (
    <View style={screenStyles.root}>
      ...
      <Text style={screenStyles.muted}>{t("auth.visitorSubtitle")}</Text>
      <TextInput
        accessibilityLabel={t("auth.email")}
        accessibilityHint={t("auth.emailHintVisitor")}
        autoCapitalize="none"
      ...
      <TextInput
        ...
        accessibilityHint={t("auth.passwordHintVisitor")}
